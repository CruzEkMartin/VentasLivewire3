        ...
        <tr>
            <td width="33%">
                ...
                @if ($sale->client->identificacion)
                    <span class="shop-info">
                        <b>Identificación:</b> {{ $sale->client->identificacion }}
                    </span>
                @endif
            ...
            <td width="33%">
                <h2 style="text-align: center;">Factura: <span class="factura-id">FV-{{ $sale->id }}</span></h2>

            </td>
            <td width="33%">
                <h3>Fecha: <span class="factura-fecha">{{ $sale->created_at }}</span></h3>
            </td>
        </tr>
    </table>
