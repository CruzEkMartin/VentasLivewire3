<x-card title="Ver venta">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <h5 class="card-header terciario">Cliente</h5>
                <div class="card-body">
                    {{-- card datos cliente --}}
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="{{ route('clientes.show', $sale->client_id) }}"
                    ...
                    <table class="table table-hover table-sm table-striped text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <x-image :item="$sale->user"></x-image>
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('usuarios.show', $sale->user) }}" class="btn btn-success btn-xs">
